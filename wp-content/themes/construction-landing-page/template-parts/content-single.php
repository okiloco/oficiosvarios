...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php if( has_post_thumbnail() ){ ?>
        <div class="post-thumbnail">
            <?php ( is_active_sidebar( 'right-sidebar' ) ) ? the_post_thumbnail( 'construction-landing-page-with-sidebar' ) : the_post_thumbnail( 'construction-landing-page-without-sidebar' ) ; ?>
        </div> 
    <?php }?>

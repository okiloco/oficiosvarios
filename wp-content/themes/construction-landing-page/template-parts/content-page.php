...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php
        if( has_post_thumbnail() ){
            ...
            ( is_active_sidebar( 'right-sidebar' ) && ( $sidebar_layout == 'right-sidebar' ) ) ? the_post_thumbnail( 'construction-landing-page-with-sidebar' ) : the_post_thumbnail( 'construction-landing-page-without-sidebar' );    
            echo '</div>';
        }
    ?>
